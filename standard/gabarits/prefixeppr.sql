...
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_procedure','attributes','prefixeppr_procedure','Table Procedure PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,NULL)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_revise','attributes','prefixeppr_revise','Table Revise PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,NULL)
 ;
...
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_perimetre_s','features','prefixeppr_perimetre_s','Table Perimetre Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_perimetreetude_s','features','prefixeppr_perimetreetude_s','Table PerimetreEtude Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns - exemple en EPSG:2154 */
INSERT INTO gpkg_geometry_columns VALUES 
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_referenceinternet','attributes','prefixeppr_referenceinternet','Table Référence Internet PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,NULL)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeareference_codealea_s','features','prefixeppr_zonealeareference_codealea_s','Table Zone Alea de Reference Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeaecheance100ans_117_s','features','prefixeppr_zonealeaecheance100ans_117_s','Table Zone Alea Echéance 100 ans Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeaexceptionnel_14_s','features','prefixeppr_zonealeaexceptionnel_14_s','Table Zone Alea Exceptionnel Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeanaturelsynthese_s','features','prefixeppr_zonealeanaturelsynthese_s','Table Zone Alea Naturel Synthese Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_zonemultialeanaturel','attributes','prefixeppr_zonemultialeanaturel','Table des aléas naturels multiples',(datetime('now')),NULL,NULL,NULL,NULL,NULL)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeatechnorapide_codealea_s','features','prefixeppr_zonealeatechnorapide_codealea_s','Table Zone Alea Technologique Rapide Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeatechnolent_codealea_s','features','prefixeppr_zonealeatechnolent_codealea_s','Table Zone Alea technologique Lent Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,/*srs_id*/2154)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeatechnoprojection_214_s','features','prefixeppr_zonealeatechnoprojection_214_s','Table Zone Alea Technologique Projection Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeatechnosynthese_s','features','prefixeppr_zonealeatechnosynthese_s','Table Zone Alea Technologique Synthese Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_zonemultialeatechno','attributes','prefixeppr_zonemultialeatechno','Table des aléas technologiques multiples',(datetime('now')),NULL,NULL,NULL,NULL,NULL)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zoneprotegee_codealea_s','features','prefixeppr_zoneprotegee_codealea_s','Table Zone Protégée Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonedangerspecifique_codealea_s','features','prefixeppr_zonedangerspecifique_codealea_s','Table Zone de danger Spécifique Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_ouvrageprotecteur_codealea_s','features','prefixeppr_ouvrageprotecteur_codealea_s','Table Ouvrage de protection Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID),
  ('prefixeppr_ouvrageprotecteur_codealea_l','features','prefixeppr_ouvrageprotecteur_codealea_l','Table Ouvrage de protection Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID),
  ('prefixeppr_ouvrageprotecteur_codealea_p','features','prefixeppr_ouvrageprotecteur_codealea_p','Table Ouvrage de protection Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_originerisque_s','features','prefixeppr_originerisque_s','Table Origine du risque Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID),
  ('prefixeppr_originerisque_l','features','prefixeppr_originerisque_l','Table Origine du risque Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID),
  ('prefixeppr_originerisque_p','features','prefixeppr_originerisque_p','Table Origine du risque Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_enjeu_s','features','prefixeppr_enjeu_s','Table Enjeux Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID),
  ('prefixeppr_enjeu_l','features','prefixeppr_enjeu_l','Table Enjeux Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID),
  ('prefixeppr_enjeu_p','features','prefixeppr_enjeu_p','Table Enjeux Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_typevulnerabilite','attributes','prefixeppr_typevulnerabilite','Table Type Vulnerabilites PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,NULL)
 ;
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonereglementaireurba_s','features','prefixeppr_zonereglementaireurba_s','Table Zone Réglementaire Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID),
  ('prefixeppr_zonereglementaireurba_l','features','prefixeppr_zonereglementaireurba_l','Table Zone Réglementaire Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID),
  ('prefixeppr_zonereglementaireurba_p','features','prefixeppr_zonereglementaireurba_p','Table Zone Réglementaire Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents - exemple en EPSG:2154*/
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonereglementairefoncier_s','features','prefixeppr_zonereglementairefoncier_s','Table Zone Réglementaire Foncier Surfacique PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID),
  ('prefixeppr_zonereglementairefoncier_l','features','prefixeppr_zonereglementairefoncier_l','Table Zone Réglementaire Foncier Linéaire PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID),
  ('prefixeppr_zonereglementairefoncier_p','features','prefixeppr_zonereglementairefoncier_p','Table Zone Réglementaire Foncier Ponctuel PPR : typeppr codegaspar',(datetime('now')),NULL,NULL,NULL,NULL,$SRS_ID)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_zoneregmultialea','attributes','prefixeppr_zoneregmultialea','Table des zonages reglementaires multi aléas',(datetime('now')),NULL,NULL,NULL,NULL,NULL)
 ;
