 ...
 * La variable ('Universal transverse Mercator fuseau 40 sud (RGR92UTM40S)',2975,'EPSG',2975, 'PROJCRS["RGR92 / UTM zone 40S",BASEGEOGCRS["RGR92",DATUM["Reseau Geodesique de la Reunion 1992",ELLIPSOID["GRS 1980",6378137,298.257222101,LENGTHUNIT["metre",1]]],PRIMEM["Greenwich",0,ANGLEUNIT["degree",0.0174532925199433]],ID["EPSG",4627]],CONVERSION["UTM zone 40S",METHOD["Transverse Mercator",ID["EPSG",9807]],PARAMETER["Latitude of natural origin",0,ANGLEUNIT["degree",0.0174532925199433],ID["EPSG",8801]],PARAMETER["Longitude of natural origin",57,ANGLEUNIT["degree",0.0174532925199433],ID["EPSG",8802]],PARAMETER["Scale factor at natural origin",0.9996,SCALEUNIT["unity",1],ID["EPSG",8805]],PARAMETER["False easting",500000,LENGTHUNIT["metre",1],ID["EPSG",8806]],PARAMETER["False northing",10000000,LENGTHUNIT["metre",1],ID["EPSG",8807]]],CS[Cartesian,2],AXIS["(E)",east,ORDER[1],LENGTHUNIT["metre",1]],AXIS["(N)",north,ORDER[2],LENGTHUNIT["metre",1]],USAGE[SCOPE["Engineering survey, topographic mapping."],AREA["Reunion - onshore and offshore - east of 54°E."],BBOX[-24.72,54,-18.28,58.24]],ID["EPSG",2975]]','La Réunion') doit être remplacée par la définition du srs correspondant dans la table gpkg_spatial_ref_sys (ex: "('Lambert-93 (RGF93LAMB93)',2154,'EPSG',2154, 'PROJCRS[\"RGF93 v1 / Lambert-93\",BASEGEOGCRS[\"RGF93 v1\",DATUM[\"Reseau Geodesique Francais 1993 v1\",ELLIPSOID[\"GRS 1980\",6378137,298.257222101,LENGTHUNIT[\"metre\",1]]],PRIMEM[\"Greenwich\",0,ANGLEUNIT[\"degree\",0.0174532925199433]],ID[\"EPSG\",4171]],CONVERSION[\"Lambert-93\",METHOD[\"Lambert Conic Conformal (2SP)\",ID[\"EPSG\",9802]],PARAMETER[\"Latitude of false origin\",46.5,ANGLEUNIT[\"degree\",0.0174532925199433],ID[\"EPSG\",8821]],PARAMETER[\"Longitude of false origin\",3,ANGLEUNIT[\"degree\",0.0174532925199433],ID[\"EPSG\",8822]],PARAMETER[\"Latitude of 1st standard parallel\",49,ANGLEUNIT[\"degree\",0.0174532925199433],ID[\"EPSG\",8823]],PARAMETER[\"Latitude of 2nd standard parallel\",44,ANGLEUNIT[\"degree\",0.0174532925199433],ID[\"EPSG\",8824]],PARAMETER[\"Easting at false origin\",700000,LENGTHUNIT[\"metre\",1],ID[\"EPSG\",8826]],PARAMETER[\"Northing at false origin\",6600000,LENGTHUNIT[\"metre\",1],ID[\"EPSG\",8827]]],CS[Cartesian,2],AXIS[\"easting (X)\",east,ORDER[1],LENGTHUNIT[\"metre\",1]],AXIS[\"northing (Y)\",north,ORDER[2],LENGTHUNIT[\"metre\",1]],USAGE[SCOPE[\"Engineering survey, topographic mapping.\"],AREA[\"France - onshore and offshore, mainland and Corsica (France métropolitaine including Corsica).\"],BBOX[41.15,-9.86,51.56,10.38]],ID[\"EPSG\",2154]]','France métropolitaine')" pour la France métropolitaine) 
 * 
 */
/**
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_perimetre_s','features','prefixeppr_perimetre_s','Table Perimetre Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns  */
INSERT INTO gpkg_geometry_columns VALUES 
  ('prefixeppr_perimetre_s','geom','MULTIPOLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES 
  ('prefixeppr_perimetreetude_s','features','prefixeppr_perimetreetude_s','Table PerimetreEtude Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns  */
INSERT INTO gpkg_geometry_columns VALUES 
  ('prefixeppr_perimetreetude_s','geom','MULTIPOLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeareference_codealea_s','features','prefixeppr_zonealeareference_codealea_s','Table Zone Alea de Reference Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonealeareference_codealea_s','geom','POLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeaecheance100ans_117_s','features','prefixeppr_zonealeaecheance100ans_117_s','Table Zone Alea Echéance 100 ans Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonealeaecheance100ans_117_s','geom','POLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeaexceptionnel_14_s','features','prefixeppr_zonealeaexceptionnel_14_s','Table Zone Alea Exceptionnel Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonealeaexceptionnel_14_s','geom','POLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeanaturelsynthese_s','features','prefixeppr_zonealeanaturelsynthese_s','Table Zone Alea Naturel Synthese Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonealeanaturelsynthese_s','geom','POLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeatechnorapide_codealea_s','features','prefixeppr_zonealeatechnorapide_codealea_s','Table Zone Alea Technologique Rapide Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonealeatechnorapide_codealea_s','geom','POLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeatechnolent_codealea_s','features','prefixeppr_zonealeatechnolent_codealea_s','Table Zone Alea technologique Lent Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonealeatechnolent_codealea_s','geom','POLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeatechnoprojection_214_s','features','prefixeppr_zonealeatechnoprojection_214_s','Table Zone Alea Technologique Projection Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonealeatechnoprojection_214_s','geom','POLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonealeatechnosynthese_s','features','prefixeppr_zonealeatechnosynthese_s','Table Zone Alea Technologique Synthese Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonealeatechnosynthese_s','geom','POLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zoneprotegee_codealea_s','features','prefixeppr_zoneprotegee_codealea_s','Table Zone Protégée Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zoneprotegee_codealea_s','geom','POLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonedangerspecifique_codealea_s','features','prefixeppr_zonedangerspecifique_codealea_s','Table Zone de danger Spécifique Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonedangerspecifique_codealea_s','geom','POLYGON',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_ouvrageprotecteur_codealea_s','features','prefixeppr_ouvrageprotecteur_codealea_s','Table Ouvrage de protection Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975),
  ('prefixeppr_ouvrageprotecteur_codealea_l','features','prefixeppr_ouvrageprotecteur_codealea_l','Table Ouvrage de protection Linéaire PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975),
  ('prefixeppr_ouvrageprotecteur_codealea_p','features','prefixeppr_ouvrageprotecteur_codealea_p','Table Ouvrage de protection Ponctuel PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_ouvrageprotecteur_codealea_s','geom','MULTIPOLYGON',2975,0,0),
  ('prefixeppr_ouvrageprotecteur_codealea_l','geom','MULTILINESTRING',2975,0,0),
  ('prefixeppr_ouvrageprotecteur_codealea_p','geom','MULTIPOINT',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_originerisque_s','features','prefixeppr_originerisque_s','Table Origine du risque Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975),
  ('prefixeppr_originerisque_l','features','prefixeppr_originerisque_l','Table Origine du risque Linéaire PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975),
  ('prefixeppr_originerisque_p','features','prefixeppr_originerisque_p','Table Origine du risque Ponctuel PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_originerisque_s','geom','MULTIPOLYGON',2975,0,0),
  ('prefixeppr_originerisque_l','geom','MULTILINESTRING',2975,0,0),
  ('prefixeppr_originerisque_p','geom','MULTIPOINT',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_enjeu_s','features','prefixeppr_enjeu_s','Table Enjeux Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975),
  ('prefixeppr_enjeu_l','features','prefixeppr_enjeu_l','Table Enjeux Linéaire PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975),
  ('prefixeppr_enjeu_p','features','prefixeppr_enjeu_p','Table Enjeux Ponctuel PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_enjeu_s','geom','MULTIPOLYGON',2975,0,0),
  ('prefixeppr_enjeu_l','geom','MULTILINESTRING',2975,0,0),
  ('prefixeppr_enjeu_p','geom','MULTIPOINT',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonereglementaireurba_s','features','prefixeppr_zonereglementaireurba_s','Table Zone Réglementaire Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975),
  ('prefixeppr_zonereglementaireurba_l','features','prefixeppr_zonereglementaireurba_l','Table Zone Réglementaire Linéaire PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975),
  ('prefixeppr_zonereglementaireurba_p','features','prefixeppr_zonereglementaireurba_p','Table Zone Réglementaire Ponctuel PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonereglementaireurba_s','geom','POLYGON',2975,0,0),
  ('prefixeppr_zonereglementaireurba_l','geom','LINESTRING',2975,0,0),
  ('prefixeppr_zonereglementaireurba_p','geom','POINT',2975,0,0)
 ;
...
/* Ajout à la table gpkg_contents */
INSERT INTO gpkg_contents VALUES
  ('prefixeppr_zonereglementairefoncier_s','features','prefixeppr_zonereglementairefoncier_s','Table Zone Réglementaire Foncier Surfacique PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975),
  ('prefixeppr_zonereglementairefoncier_l','features','prefixeppr_zonereglementairefoncier_l','Table Zone Réglementaire Foncier Linéaire PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975),
  ('prefixeppr_zonereglementairefoncier_p','features','prefixeppr_zonereglementairefoncier_p','Table Zone Réglementaire Foncier Ponctuel PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2975)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
  ('prefixeppr_zonereglementairefoncier_s','geom','POLYGON',2975,0,0),
  ('prefixeppr_zonereglementairefoncier_l','geom','LINESTRING',2975,0,0),
  ('prefixeppr_zonereglementairefoncier_p','geom','POINT',2975,0,0)
 ;
