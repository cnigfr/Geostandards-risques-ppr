...
INSERT INTO gpkg_contents VALUES
  ...
  ('prefixeppr_ouvrageprotecteur_codealea_p','features','prefixeppr_ouvrageprotecteur_codealea_p','Table Ouvrage de protection Ponctuel PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2972)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
INSERT INTO gpkg_contents VALUES
  ...
  ('prefixeppr_originerisque_p','features','prefixeppr_originerisque_p','Table Origine du risque Ponctuel PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2972)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
INSERT INTO gpkg_contents VALUES
  ...
  ('prefixeppr_enjeu_p','features','prefixeppr_enjeu_p','Table Enjeux Ponctuel PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2972)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
INSERT INTO gpkg_contents VALUES
  ...
  ('prefixeppr_zonereglementaireurba_p','features','prefixeppr_zonereglementaireurba_p','Table Zone Réglementaire Ponctuel PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2972)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
...
INSERT INTO gpkg_contents VALUES
  ...
  ('prefixeppr_zonereglementairefoncier_p','features','prefixeppr_zonereglementairefoncier_p','Table Zone Réglementaire Foncier Ponctuel PPR : typeppr codegaspar',(strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),NULL,NULL,NULL,NULL,2972)
 ;
/* Ajout à la table gpkg_geometry_columns */
INSERT INTO gpkg_geometry_columns VALUES
